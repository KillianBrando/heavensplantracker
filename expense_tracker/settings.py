...
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.locmem.LocMemCache',  # In-memory cache backend for local development
        'LOCATION': 'unique-snowflake',  # Unique identifier for the cache
    }
}

# Optionally, set cache timeout globally (default timeout for cache views)
CACHE_MIDDLEWARE_SECONDS = 60 * 15  # 15 minutes cache time
